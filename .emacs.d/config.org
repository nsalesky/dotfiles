...
This defines a little function so that ~esc~ doesn't toggle =god-mode= when I'm in a recursive edit (like in the minibuffer), and can instead be used to exit one recursive layer. I got it from [[https://www.reddit.com/r/emacs/comments/3pk8rl/exiting_godmode_with_the_escape_key/]]
#+BEGIN_SRC emacs-lisp
;; (defun ns/escape ()
;;   (interactive)
